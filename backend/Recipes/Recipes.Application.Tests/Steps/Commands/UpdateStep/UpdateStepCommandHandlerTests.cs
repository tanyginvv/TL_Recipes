...
public class UpdateStepCommandHandlerTests
{
    ...
    private readonly Mock<ILogger<UpdateStepCommand>> _loggerMock;
    ...
    public UpdateStepCommandHandlerTests()
    {
        ...
        _loggerMock = new Mock<ILogger<UpdateStepCommand>>();
        _handler = new UpdateStepCommandHandler( _stepRepositoryMock.Object, _validatorMock.Object, _loggerMock.Object );
    }

...
public class CreateStepCommandHandlerTests
{
    ...
    private readonly Mock<ILogger<CreateStepCommand>> _loggerMock;
    ...
    public CreateStepCommandHandlerTests()
    {
        ...
        _loggerMock = new Mock<ILogger<CreateStepCommand>>();
        _handler = new CreateStepCommandHandler( _stepRepositoryMock.Object, _validatorMock.Object, _loggerMock.Object );
    }

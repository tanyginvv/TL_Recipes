...
{
    public class GetFavouriteBoolRecipeAndUserQueryValidator(
        IRecipeRepository recipeRepository,
        IUserRepository userRepository
        ) : IAsyncValidator<GetFavouriteBoolRecipeAndUserQuery>
    {
        public async Task<Result> ValidateAsync( GetFavouriteBoolRecipeAndUserQuery command )
        {

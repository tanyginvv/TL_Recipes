...
public class DeleteIngredientCommandHandlerTests
{
    ...
    private readonly Mock<ILogger<DeleteIngredientCommand>> _logger;

    public DeleteIngredientCommandHandlerTests()
    {
        _ingredientRepositoryMock = new Mock<IIngredientRepository>();
        _validatorMock = new Mock<IAsyncValidator<DeleteIngredientCommand>>();
        _logger = new Mock<ILogger<DeleteIngredientCommand>>();
        _handler = new DeleteIngredientCommandHandler( _ingredientRepositoryMock.Object, _validatorMock.Object, _logger.Object );
    }
